...
export default function Contact() {
    ...
    return (
        <div id="contact" className="w-full px-[12%] py-10 scroll-mt-20 bg-[url('./assets/footer-bg-color.png')] bg-no-repeat bg-[length:90%_auto] bg-center dark:bg-none">
            ...
            <h4 className="text-center mb-2 text-lg  zalando-sans-midheading">Connect with me</h4>
            <h2 className="text-center text-5xl  zalando-sans-midheading">Get in touch</h2>
            <p className="text-center max-w-2xl mx-auto mt-5 mb-12  zalando-sans-midheading">I&apos;d love to hear from you! If you have any questions, comments or feedback, please use the form below.</p>
